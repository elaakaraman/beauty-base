...

{
    ...
    puan: 4.8,
    etiket: "ÇOK SATAN",
    resim: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.7,
    etiket: "YENİ",
    resim: "https://images.unsplash.com/photo-1583241800698-e8ab01830a07?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.9,
    etiket: "ÇOK SATAN",
    resim: "https://images.unsplash.com/photo-1612817288484-6f916006741a?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.6,
    etiket: "YENİ",
    resim: "https://images.unsplash.com/photo-1631730486572-226d1d8d262a?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.8,
    etiket: "",
    resim: "https://images.unsplash.com/photo-1586495777744-4413f21062fa?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.9,
    etiket: "EXCLUSIVE",
    resim: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.7,
    etiket: "",
    resim: "https://images.unsplash.com/photo-1631214524020-7e18db9a8f92?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.8,
    etiket: "YENİ",
    resim: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.6,
    etiket: "",
    resim: "https://images.unsplash.com/photo-1556229010-6c3f2c9ca5f8?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.8,
    etiket: "ÇOK SATAN",
    resim: "https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.9,
    etiket: "EXCLUSIVE",
    resim: "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.8,
    etiket: "ÇOK SATAN",
    resim: "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.7,
    etiket: "YENİ",
    resim: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.6,
    etiket: "",
    resim: "https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?auto=format&fit=crop&w=600&q=80",
...

{
    ...
    puan: 4.7,
    etiket: "YENİ",
    resim: "https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?auto=format&fit=crop&w=600&q=80",
...
document.getElementById("urunSayisi").textContent =
    `${liste.length} ürün`;
...
// SAYFA AÇILINCA ÜRÜNLERİ GÖSTER
